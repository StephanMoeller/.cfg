...
vim.keymap.set('n', '<s-Up>', '10<Up>zz', { desc = 'Navigate with crlt arrows instead of c-d and c-u' })
vim.keymap.set('v', '<s-Up>', '10<Up>zz', { desc = 'Navigate with crlt arrows instead of c-d and c-u' })
vim.keymap.set('n', '<s-Down>', '10<Down>zz', { desc = 'Navigate with crlt arrows instead of c-d and c-u' })
vim.keymap.set('v', '<s-Down>', '10<Down>zz', { desc = 'Navigate with crlt arrows instead of c-d and c-u' })
